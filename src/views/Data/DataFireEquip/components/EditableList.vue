<template lang="html">
  <div class="common-editable">
    <el-table stripe border height="100%" :data="list" size="mini" class="grid-table" header-cell-class-name="grid-table-hd" @selection-change="_TableSelectionChange">
      ...
      <el-table-column prop="tnSfxs" label="显示" align="center" width="75px">
      ...
      <el-table-column prop="tnLk" label="列宽" width="75px">
        <input type="text" slot-scope="scope" v-model="scope.row['tnLk']"   :class="getAlertClass(scope.row, 'tnLk')" ></input>
      </el-table-column>
      <el-table-column prop="tcMrz" label="默认值" width="75px">
        <input type="text" slot-scope="scope" v-model="scope.row['tcMrz']"   :class="getAlertClass(scope.row, 'tcMrz')" ></input>
      </el-table-column>

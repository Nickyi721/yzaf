<template>
  <CustomView :location="[{ text: '新增安保机构' }]">
    <el-form ref="form" :model="formData" :rules="rules" label-position="top" label-width="300px" class="common-form">
      <el-form-item label="安保机构名称" prop="tcAbjgmc">
        <el-input v-model="formData['tcAbjgmc']" :disabled="disabled" size="mini" placeholder="请输入机构名称"></el-input>
      </el-form-item>
      <el-form-item label="安保机构地址" prop="tcDz">
        <el-input v-model="formData['tcDz']" :disabled="disabled" size="mini" placeholder="请输入机构地址"></el-input>
      </el-form-item>
      ...
      <el-form-item label="安保机构性质" prop="tcAbjgxz">
        <el-select v-model="formData['tcAbjgxz']" :disabled="disabled" placeholder="请选择信息类型" size="mini" style="width:300px">
      ...
      <!-- <el-form-item label="专、兼职安保人员数量" prop="tnRysl">
        <el-input v-model="formData['tnRysl']" :disabled="disabled" size="mini" placeholder="请输入专、兼职安保人员数量"></el-input>
      </el-form-item> -->
      <el-form-item label="是否有外包人员" prop="tcWbbz">
        <el-select v-model="formData['tcWbbz']" :disabled="disabled" placeholder="请选择是否有外包人员" size="mini" style="width:300px">
      ...
      <el-form-item label="外包安保人员数量" prop="tnWbrysl" v-if="formData['tcWbbz']" >
        <el-input v-model="formData['tnWbrysl']" :disabled="disabled" size="mini" placeholder="请输入外包安保人员数量"></el-input>
      </el-form-item>
      <el-form-item label="邮政编码" prop="tcYzbm">
        <el-input v-model="formData['tcYzbm']" :disabled="disabled" size="mini" placeholder="请输入邮政编码"></el-input>
      </el-form-item>
      <el-form-item label="机构电话" prop="tcCzdh">
        <el-input v-model="formData['tcCzdh']" :disabled="disabled" size="mini" placeholder="请输入机构电话"></el-input>
      </el-form-item>
      <el-form-item>
  ...
  methods: {
    ...
    async addData(){
      ...
      if (result.state==="1") {
        ...
        this.$router.push({name: 'guardOrg'})
      }
      // else{
      //   let _this = this
      //   this.$message({

  ...
  <div class="el-calendar">
    <div class="el-calendar__header">
      ...
      <div
        ...
        <el-button-group>
           <el-button size="small" style="height:28px;" @click="_ButtonAddClick">
             排班时间设置
           </el-button>
          <el-button
            type="plain"
...
import { validateRangeInOneMonth } from '@commons/date-util';
...
export default {
  ...
  methods: {
    ...
    selectDate(type) {
      ...
      if (type === 'prev-month') {
        ...
        let preMon = day.slice(0,7)
        this.$emit('getPreMonth',preMon)
      } else if (type === 'next-month') {
        day = `${this.nextMonthDatePrefix}-01`;
        let nextMon = day.slice(0,7)
        this.$emit('getNextMonth',nextMon)
      } else {
  ...
  computed: {
    ...
    i18nDate() {
      ...
      let  month = this.formatedDate.slice(5, 7);
